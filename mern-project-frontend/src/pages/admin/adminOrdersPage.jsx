...
import OrderModal from "../../components/orderInfoModal.jsx";

export default function AdminOrdersPage() {

	const [orders, setOrders] = useState([]);            
	const [isLoading, setIsLoading] = useState(true); 
	const [isModalOpen, setIsModalOpen] = useState(false);  // modal for create a popup notification of oder details
	const [selectedOrder, setSelectedOrder] = useState(null);  // find active order to show details

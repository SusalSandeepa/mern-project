...
export default function UpdateProductPage() {
  ...
  async function updateProduct() {
    ...
    try {
      ...
      if (urls.length == 0) {
        urls = location.state.images; // if user didin't update any image keep the old images as it is
      }
      ...
      const product = {
        ...
        stock: stock,
	  	...
	  	// call the backend using axios to update products
      await axios.put(
        ...
        <div className="px-6 py-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <label className="flex flex-col gap-1.5">
              ...
              <input
                disabled // this is use to make the product Id unchangable when update a product
